...
title: "Katakolo, Greece"
date: 2024-11-07
img: legacy/IMG_0735.webp
...
{% image "legacy/IMG_0735.webp", "2048x1536" %}
...
{% image "legacy/image34.webp", "782x891" %}
{% image "legacy/image35.webp", "749x830" %}

Fancy sundial and then our youngest son does Tech Theater, so some Greek theater technology to show him. Lastly, the picture enlargement tool. They also had puzzle games that you could try out. 

{% image "legacy/IMG_0741.webp", "1536x2048" %}
{% image "legacy/IMG_0742.webp", "2048x1536" %}
{% image "legacy/IMG_0746.webp", "2048x1536" %}
{% image "legacy/IMG_0747.webp", "1536x2048" %}

After the museum, we hiked up next to this church to get a view out over the water. 

{% image "legacy/IMG_0749.webp", "2048x1536" %}
{% image "legacy/IMG_0750.webp", "2048x1536" %}
{% image "legacy/IMG_0755.webp", "1536x2048" %}
{% image "legacy/IMG_0761.webp", "2048x1536" %}
{% image "legacy/IMG_0762.webp", "2048x1536" %}
{% image "legacy/IMG_0767.webp", "2048x1536" %}
...
{% image "legacy/IMG_0771.webp", "2048x1536" %}
{% image "legacy/IMG_0772.webp", "2048x1536" %}
{% image "legacy/IMG_0773.webp", "2048x1536" %}
{% image "legacy/IMG_0774.webp", "1536x2048" %}
...
{% image "legacy/IMG_0775.webp", "2048x1536" %}
{% image "legacy/IMG_0776.webp", "2048x1536" %}
{% image "legacy/IMG_0777.webp", "2048x1536" %}
