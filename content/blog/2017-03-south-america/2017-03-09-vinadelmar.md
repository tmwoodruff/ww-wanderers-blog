...
title: "Vina del Mar and Embarkation"
date: 2017-03-09
...
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6767_35260846271_c.800x600.webp", "800x600" %}
...
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6769_35003466090_c.800x600.webp", "800x600" %}
...
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6778_35260848471_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6780_35389969295_c.600x800.webp", "600x800" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6781_35260849891_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6782_35389969985_c.800x600.webp", "800x600" %}

Continuing our walk on the coast

{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6784_35260851221_c.800x600.webp", "800x600" %}

The ship getting fueled, still in the middle of the ocean. 

{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6785_35389970335_c.800x600.webp", "800x600" %}

Wulff Castle

{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6786_35260852021_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6792_35389970675_c.800x600.webp", "800x600" %}
...
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6798_35260854901_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6802_35260855621_c.800x600.webp", "800x600" %}
...
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6804_35260856391_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6805_35260856701_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6806_35260857251_c.800x600.webp", "800x600" %}

Our room was ready since we boarded so late. From the bus, it looked like our luggage was still sitting there. However, it did not take too long to get our luggage--we had it after dinner, so it must have been another wave after us. We should have just carried it on if we knew it was going to 5:30 hours to get onboard. We were starving, so we went up to the buffet for a small snack to hold us over and enjoy on the deck at the Great Outdoors. I had the Moderno (Brazilian steakhouse) reserved for dinner at 6:30 pm. My thinking was that we would not be full yet from too much cruise food everywhere and would be hungry. We were hungry. We went to check the reservation since we were not sure how the delayed schedule with muster drill needed would impact our reservation. They noted that we were reserved and did not seem concerned about the muster drill. My husband planned to wear what he was wearing, and I had my dress in my carry on. We went to our dinner reservation and were the only ones there the full time, which is a little odd for a Brazilian steakhouse since they normally walk around with meat on a stick and use the "go" and "stop" bringing more signs. They just brought us two of everything to our table. We read about the cod in the banana leaf; my husband requested one. After we tried everything, our waitress, who spotted us and said hi several other times during the cruise, asked what our favorite was, and she brought us each our favorite. My favorite was the garlic beef. Filet is normally my favorite but not here. I was not a big fan of the rib, both pork and beef. My husband like the beef ribs. He had the papaya dessert. I skipped dessert after eating so much meat. It was good. We finished just in time for the muster drill announcements. Our waitress was pulled away before we left for the drill.
...
Dinner with my new dress. 

{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6809_35260857931_c.800x600.webp", "800x600" %}
{% image "https://assets.ww-wanderers.cc/images/2017-03-VinadelMar/img_6810_35260858361_c.600x800.webp", "600x800" %}
