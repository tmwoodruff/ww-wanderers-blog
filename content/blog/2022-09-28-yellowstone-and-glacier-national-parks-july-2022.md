...
{% image "legacy/IMG_5316.webp", "2048x1536" %}

And then more of his friends. Owen wanted his picture taken with the bighorn sheep. 

{% image "legacy/IMG_5320.webp", "1536x2048" %}
{% image "legacy/P1110594.webp", "2048x1538" %}

Starting the trail, which starts as a boardwalk. 

{% image "legacy/P1110603.webp", "2048x1538" %}
...
{% image "legacy/IMG_5326.webp", "1536x2048" %}
{% image "legacy/IMG_5328.webp", "2048x1536" %}

We arrived at the Hidden Lake lookout where the trail was closed to the Lake for bear activity. 

{% image "legacy/P1110636.webp", "2048x1538" %}
{% image "legacy/P1110647.webp", "2048x1538" %}

We found this guy. He had scared another group of hikers by trying to block them from part of the trail. 

{% image "legacy/P1110661.webp", "2048x1538" %}
{% image "legacy/P1110665.webp", "2048x1538" %}
{% image "legacy/P1110668.webp", "2048x1538" %}

Pika (?) busy working. 

{% image "legacy/P1110671.webp", "2048x1366" %}

There were guys snowboarding down the hills. Ours found a snow melt.

{% image "legacy/P1110676.webp", "1538x2048" %}
{% image "legacy/P1110679.webp", "2048x1538" %}

Owen's footprint in the snow hiking; we slid to the side.

{% image "legacy/IMG_5349.webp", "2048x1536" %}
{% image "legacy/IMG_5345.webp", "2048x1536" %}
{% image "legacy/IMG_5348.webp", "2048x1536" %}
...
{% image "legacy/IMG_5350.webp", "2048x1366" %}
{% image "legacy/IMG_5353.webp", "2048x1536" %}
{% image "legacy/IMG_5354.webp", "2048x1536" %}
...
{% image "legacy/IMG_5361.webp", "2048x1536" %}
...
{% image "legacy/IMG_5366.webp", "2048x1536" %}

From the trail, there is a great view of a waterfall that is above, under, and below the Going-to-the-Sun Road. 

{% image "legacy/IMG_5369.webp", "1536x2048" %}
{% image "legacy/P1110829.webp", "1538x2048" %}
{% image "legacy/P1110832.webp", "2048x1538" %}
...
{% image "legacy/IMG_5371.webp", "2048x1536" %}
{% image "legacy/P1110711.webp", "2048x1538" %}

A tunnel and a window out of a tunnel. 

{% image "legacy/P1110717.webp", "2048x1538" %}
{% image "legacy/P1110718.webp", "2048x1538" %}
{% image "legacy/P1110705.webp", "2048x1538" %}
...
{% image "legacy/P1110737.webp", "2048x1538" %}
{% image "legacy/P1110747.webp", "2048x1538" %}
{% image "legacy/P1110776.webp", "2048x1538" %}
{% image "legacy/P1110765.webp", "2048x1538" %}
{% image "legacy/P1110794.webp", "1538x2048" %}

We arrived at Avalanche Lake; it was very pretty with greens, blues, and turquoises with waterfalls coming down behind it. 

{% image "legacy/IMG_5395.webp", "2048x1536" %}

Back on the Trail of Cedars, a cool view up. Also, many ferns growing in the underbrush below the boardwalk. 

{% image "legacy/P1110795.webp", "2048x1538" %}
{% image "legacy/P1110797.webp", "2048x1538" %}
...
{% image "legacy/IMG_5428.webp", "1536x2048" %}
{% image "legacy/P1110873.webp", "2048x1538" %}
{% image "legacy/IMG_5410.webp", "2048x1536" %}

Many waterfalls along the road. 

{% image "legacy/P1110819.webp", "2048x1538" %}
{% image "legacy/IMG_5423.webp", "2048x1536" %}
{% image "legacy/P1110859.webp", "1538x2048" %}

Weeping wall  

{% image "legacy/P1110845.webp", "2048x1538" %}
{% image "legacy/P1110850.webp", "2048x1538" %}
{% image "legacy/P1110824.webp", "2048x1538" %}

I was thinking that it was nice and cool due to the elevation, but then determined that I was standing on snow. 

{% image "legacy/P1110856.webp", "2048x1538" %}
{% image "legacy/P1110857.webp", "2048x1538" %}
{% image "legacy/P1110862.webp", "2048x1538" %}

This was a horse trail. 

{% image "legacy/IMG_5434.webp", "1536x2048" %}
{% image "legacy/P1110874.webp", "1538x2048" %}

Goose Island in Saint Mary Lake. 

{% image "legacy/IMG_5436.webp", "2048x1536" %}
{% image "legacy/IMG_5442.webp", "2048x1536" %}

Hiking around Saint Mary Lake. 

{% image "legacy/IMG_5446.webp", "2048x1536" %}
