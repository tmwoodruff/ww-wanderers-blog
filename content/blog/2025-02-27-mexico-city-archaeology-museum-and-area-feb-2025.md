...
{% image "legacy/IMG_1810.webp", "2048x1536" %}
{% image "legacy/IMG_1811.webp", "2048x1536" %}
...
{% image "legacy/IMG_1812.webp", "1536x2048" %}{% image "legacy/IMG_1814.webp", "1536x2048" %}
{% image "legacy/IMG_1816.webp", "1536x2048" %}{% image "legacy/IMG_1817.webp", "1536x2048" %}
{% image "legacy/IMG_1818.webp", "2048x1536" %}
...
{% image "legacy/IMG_1819.webp", "2048x1536" %}
{% image "legacy/IMG_1821.webp", "2048x1536" %}

The Aztecs, for a ceremony, would dress up as eagles, continuing the eagle theme. 

{% image "legacy/IMG_1822.webp", "1536x2048" %}
{% image "legacy/IMG_1823.webp", "2048x1536" %}
{% image "legacy/IMG_1824.webp", "2048x1536" %}
{% image "legacy/IMG_1825.webp", "2048x1536" %}
{% image "legacy/IMG_1826.webp", "1536x2048" %}
{% image "legacy/IMG_1828.webp", "2048x1536" %}
{% image "legacy/IMG_1830.webp", "2048x1536" %}

We got to the Mexica gallery with Teotihuacan pyramid replicas (in color) that we saw in person the day before. 

{% image "legacy/IMG_1832.webp", "2048x1536" %}
{% image "legacy/IMG_1833.webp", "2048x1536" %}
{% image "legacy/IMG_1835.webp", "2048x1536" %}
{% image "legacy/IMG_1836.webp", "2048x1536" %}

Prisoners were sacrificed to the gods and buried in the pyramids. Pyramids in Mexico were not used as tombs like in Egypt, but for worship of the gods, with this exception.   

{% image "legacy/IMG_1837.webp", "2048x1536" %}
{% image "legacy/IMG_1841.webp", "2048x1536" %}
{% image "legacy/IMG_1844.webp", "2048x1536" %}
{% image "legacy/IMG_1845.webp", "1536x2048" %}
...
{% image "legacy/IMG_1846.webp", "2048x1536" %}
{% image "legacy/IMG_1847.webp", "2048x1536" %}
{% image "legacy/IMG_1848.webp", "2048x1536" %}
{% image "legacy/IMG_1849.webp", "2048x1536" %}
{% image "legacy/IMG_1850.webp", "2048x1536" %}
{% image "legacy/IMG_1852.webp", "2048x1536" %}

I was impressed with the bamboo, and we found the Jade mask. 

{% image "legacy/IMG_1853.webp", "1536x2048" %}{% image "legacy/IMG_1854.webp", "1536x2048" %}
...
{% image "legacy/IMG_1858.webp", "1536x2048" %}
{% image "legacy/IMG_1859.webp", "2048x1536" %}
...
{% image "legacy/IMG_1862.webp", "1536x2048" %}
...
{% image "legacy/IMG_1868.webp", "2048x1536" %}
{% image "legacy/IMG_1869.webp", "2048x1536" %}
{% image "legacy/IMG_1871.webp", "2048x1536" %}
{% image "legacy/IMG_1864.webp", "2048x1536" %}
{% image "legacy/IMG_1873.webp", "2048x1536" %}
{% image "legacy/IMG_1876.webp", "2048x1536" %}
{% image "legacy/IMG_1877.webp", "2048x1536" %}
{% image "legacy/IMG_1878.webp", "2048x1536" %}
{% image "legacy/IMG_1879.webp", "2048x1536" %}
{% image "legacy/IMG_1880.webp", "2048x1536" %}
{% image "legacy/IMG_1882.webp", "2048x1536" %}
{% image "legacy/IMG_1883.webp", "2048x1536" %}
{% image "legacy/IMG_1884.webp", "1536x2048" %}
{% image "legacy/IMG_1887.webp", "2048x1536" %}

Here is the eagle, snake, and cactus from the legend again on the walk down from the castle. 

{% image "legacy/IMG_1888.webp", "2048x1536" %}
{% image "legacy/IMG_1889.webp", "1536x2048" %}
...
{% image "legacy/IMG_1890.webp", "2048x1536" %}
...
{% image "legacy/IMG_1897.webp", "2048x1536" %}
{% image "legacy/IMG_1902.webp", "2048x1536" %}
{% image "legacy/IMG_1903.webp", "2048x1536" %}
{% image "legacy/IMG_1905.webp", "2048x1536" %}

We decided to try a fine dining experience tonight. I heard to do fine dining because it is more affordable in Mexico. Travis's sister recommended the Sonoma Grill. It was in the Hilton in Centro across from Alameda Central park. Since it was Friday night, we made an online reservation for 5:30 pm; though it was not very crowded, so probably not required. We dressed up best we could; we did not bring any dressy clothes. Some people were dressed up, though a guy at the table next to us had shorts on. In the reservation, we requested a normal height table but were still seated at a high table. Just harder to be comfortable seated in a high bar stool while trying to eat. Another group moved from a high table to a normal height table.
