...
{% image "legacy/IMG_1532.webp", "2048x1536" %}
{% image "legacy/IMG_1535.webp", "2048x1536" %}
{% image "legacy/IMG_1543.webp", "2048x1536" %}
...
{% image "legacy/IMG_1537.webp", "2048x1536" %}
{% image "legacy/IMG_1538.webp", "2048x1536" %}
...
{% image "legacy/IMG_1540.webp", "2048x1536" %}
{% image "legacy/IMG_1541.webp", "2048x1536" %}
{% image "legacy/IMG_1558.webp", "2048x1536" %}
...
{% image "legacy/IMG_1617.webp", "1536x2048" %}
{% image "legacy/IMG_1548.webp", "1536x2048" %}{% image "legacy/IMG_1549.webp", "1536x2048" %}
{% image "legacy/IMG_1553.webp", "2048x1536" %}
{% image "legacy/IMG_1559.webp", "2048x1536" %}
...
{% image "legacy/IMG_1561.webp", "2048x1536" %}

Though not as exciting, other city views that you can get from the Sears cafe. 

{% image "legacy/IMG_1562.webp", "2048x1536" %}
{% image "legacy/IMG_1566.webp", "2048x1536" %}
{% image "legacy/IMG_1569.webp", "2048x1536" %}
{% image "legacy/IMG_1570.webp", "2048x1536" %}
...
{% image "legacy/IMG_1574.webp", "2048x1536" %}
{% image "legacy/IMG_1575.webp", "2048x1536" %}
{% image "legacy/IMG_1576.webp", "2048x1536" %}
{% image "legacy/IMG_1578.webp", "2048x1536" %}
{% image "legacy/IMG_1580.webp", "2048x1536" %}
...
{% image "legacy/IMG_1583.webp", "2048x1536" %}
{% image "legacy/IMG_1585.webp", "2048x1536" %}
...
{% image "legacy/IMG_1595.webp", "2048x1536" %}
{% image "legacy/IMG_1596.webp", "2048x1536" %}
{% image "legacy/IMG_1597.webp", "2048x1536" %}
...
{% image "legacy/IMG_1599.webp", "2048x1536" %}
{% image "legacy/IMG_1600.webp", "2048x1536" %}
{% image "legacy/IMG_1602.webp", "2048x1536" %}
{% image "legacy/IMG_1603.webp", "1536x2048" %}
{% image "legacy/IMG_1604.webp", "2048x1536" %}
{% image "legacy/IMG_1605.webp", "1536x2048" %}
{% image "legacy/IMG_1606.webp", "2048x1536" %}
{% image "legacy/IMG_1607.webp", "2048x1536" %}
{% image "legacy/IMG_1608.webp", "2048x1536" %}
{% image "legacy/IMG_1609.webp", "2048x1536" %}
{% image "legacy/IMG_1610.webp", "2048x1536" %}
{% image "legacy/IMG_1611.webp", "2048x1536" %}
{% image "legacy/IMG_1612.webp", "2048x1536" %}
{% image "legacy/IMG_1613.webp", "2048x1536" %}
{% image "legacy/IMG_1614.webp", "2048x1536" %}
{% image "legacy/IMG_20250205_114333725_HDR.webp", "2048x1151" %}
{% image "legacy/IMG_20250205_114759954_HDR.webp", "2048x1151" %}
{% image "legacy/IMG_20250205_115204972_HDR.webp", "2048x1151" %}
{% image "legacy/IMG_1616.webp", "1536x2048" %}
...
{% image "legacy/IMG_1620.webp", "2048x1536" %}
{% image "legacy/IMG_1622.webp", "2048x1536" %}
...
{% image "legacy/IMG_1623.webp", "2048x1536" %}
{% image "legacy/IMG_1635.webp", "2048x1536" %}
{% image "legacy/IMG_1637.webp", "2048x1536" %}
...
{% image "legacy/IMG_1626.webp", "1536x2048" %}
{% image "legacy/IMG_1627.webp", "1536x2048" %}
{% image "legacy/IMG_1628.webp", "1536x2048" %}
{% image "legacy/IMG_1629.webp", "2048x1536" %}
{% image "legacy/IMG_1630.webp", "2048x1536" %}

Back to the Zócalo or Plaza of the Constitution, we looked at the buildings in more detail and then visited the Cathedral. 

{% image "legacy/IMG_1631.webp", "2048x1536" %}
{% image "legacy/IMG_1641.webp", "1536x2048" %}
{% image "legacy/IMG_1633.webp", "2048x1536" %}
{% image "legacy/IMG_1634.webp", "2048x1536" %}
{% image "legacy/IMG_1638.webp", "2048x1536" %}
...
{% image "legacy/IMG_1642.webp", "1536x2048" %}
...
{% image "legacy/IMG_1646.webp", "2048x1536" %}
{% image "legacy/IMG_1645.webp", "2048x1536" %}

The waste water drainage pipe was interesting. 

{% image "legacy/IMG_1662.webp", "2048x1536" %}
{% image "legacy/IMG_1663.webp", "1536x2048" %}{% image "legacy/IMG_1698.webp", "1536x2048" %}
...
{% image "legacy/IMG_1658.webp", "1536x2048" %}{% image "legacy/IMG_1650.webp", "1536x2048" %}
{% image "legacy/IMG_1656.webp", "2048x1536" %}

The snakes

{% image "legacy/IMG_1654.webp", "2048x1536" %}
{% image "legacy/IMG_1651.webp", "2048x1536" %}
{% image "legacy/IMG_1653.webp", "2048x1536" %}

I liked when colors still showed up. 

{% image "legacy/IMG_1679.webp", "2048x1536" %}
{% image "legacy/IMG_1676.webp", "2048x1536" %}
{% image "legacy/IMG_1675.webp", "2048x1536" %}
{% image "legacy/IMG_1670.webp", "1536x2048" %}
{% image "legacy/IMG_1660.webp", "2048x1536" %}
{% image "legacy/IMG_1665.webp", "2048x1536" %}
{% image "legacy/IMG_1673.webp", "2048x1536" %}

A replicate, in full color, of the previously pictured statue. 

{% image "legacy/IMG_1690.webp", "2048x1536" %}
{% image "legacy/IMG_1688.webp", "2048x1536" %}
{% image "legacy/IMG_1687.webp", "1536x2048" %}
{% image "legacy/IMG_1684.webp", "2048x1536" %}
{% image "legacy/IMG_1692.webp", "2048x1536" %}

Inside the big museum. It was very interesting and well done, but we did not have enough time to see it all in depth. 

{% image "legacy/IMG_1696.webp", "2048x1536" %}
{% image "legacy/IMG_1694.webp", "1536x2048" %}
...
Next up...[Teotihuacan pyramids excursion](https://ww-wanderers.blogspot.com/2025/02/mexico-city-teotihuacan-pyramids-tour.html)
