...
{% image "legacy/IMG_6071.webp", "2048x1536" %}
...
{% image "legacy/IMG_6072.webp", "2048x1536" %}

View on the way to the lighthouse trail start. 

{% image "legacy/IMG_6073.webp", "2048x1536" %}
...
{% image "legacy/IMG_6075.webp", "2048x1536" %}
{% image "legacy/IMG_6080.webp", "2048x1536" %}
{% image "legacy/IMG_6085.webp", "2048x1536" %}
{% image "legacy/IMG_6091.webp", "2048x1536" %}

When it is your turn, you go with a group, take off your shoes, and view/take pictures until your group's turn is up. 

{% image "legacy/IMG_6099.webp", "2048x1536" %}
{% image "legacy/IMG_6100.webp", "2048x1536" %}
{% image "legacy/IMG_6103.webp", "2048x1536" %}
{% image "legacy/IMG_6104.webp", "2048x1536" %}
{% image "legacy/IMG_6105.webp", "2048x1536" %}
{% image "legacy/IMG_6106.webp", "2048x1536" %}
{% image "legacy/IMG_6108.webp", "1536x2048" %}

Then there was another area for view pictures. They also had a small photo exhibit. 

{% image "legacy/IMG_6112.webp", "2048x1536" %}
{% image "legacy/IMG_6113.webp", "2048x1536" %}
{% image "legacy/IMG_6115.webp", "1536x2048" %}
{% image "legacy/IMG_6120.webp", "2048x1536" %}
{% image "legacy/IMG_6131.webp", "2048x1536" %}

Then we walked toward the theater. We walked along the coast. This was cool art. 

{% image "legacy/IMG_6133.webp", "2048x1536" %}
{% image "legacy/IMG_6136.webp", "2048x1536" %}
...
{% image "legacy/IMG_6141.webp", "1536x2048" %}
{% image "legacy/IMG_6144.webp", "2048x1536" %}
{% image "legacy/IMG_6152.webp", "2048x1536" %}
{% image "legacy/IMG_6154.webp", "1536x2048" %}
...
{% image "legacy/IMG_6155.webp", "2048x1536" %}

A pretty church that I had not noticed earlier caught my eye. 

{% image "legacy/IMG_6158.webp", "2048x1536" %}

I remembered to captured some menus. 

{% image "legacy/Screenshot_20230124-200935.webp", "1080x1920" %} {% image "legacy/Screenshot_20230124-200947.webp", "1080x1920" %} {% image "legacy/Screenshot_20230124-201010.webp", "1080x1920" %}
...
{% image "legacy/IMG_6161.webp", "1536x2048" %}
{% image "legacy/IMG_6162.webp", "2048x1536" %}
{% image "legacy/IMG_6163.webp", "1536x2048" %}
{% image "legacy/IMG_6164.webp", "2048x1536" %}
