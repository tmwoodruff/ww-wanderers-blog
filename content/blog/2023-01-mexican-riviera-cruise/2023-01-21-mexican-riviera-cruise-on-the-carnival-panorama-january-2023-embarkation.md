...
title: "Embarkation"
date: 2023-01-21
img: legacy/IMG_5926.webp
tags: [Long Beach, embarkation, Carnival Panorama, California, United States]
country: us
state: ca
author: Tammy
description: ""
...
{% image "legacy/IMG_5926.webp", "2048x1536" %}
...
{% image "legacy/IMG_5929.webp", "2048x1536" %}
{% image "legacy/IMG_5931.webp", "2048x1536" %}

Another view of the lighthouse that we visited the night before, and another view of Queen Mary.

{% image "legacy/IMG_5933.webp", "2048x1536" %}
{% image "legacy/IMG_5937.webp", "2048x1536" %}
...
{% image "legacy/IMG_5948.webp", "2048x1536" %}
{% image "legacy/IMG_5949.webp", "2048x1536" %}

Goodbye Long Beach

{% image "legacy/IMG_5950.webp", "2048x1536" %}

This was the Upper Promenade. It was nice with good seating spots and some restaurants' al fresco dining -- mainly the Guy's Pig and Anchor. However, it was not good for walking the promenade; it was closed off at the front for crew area and at the back for the Havana pool area (Havana only room guest allowed). The Lower Promenade was labeled inside the ship, but it was unclear if we were allowed to be on it. One crew member told us that we could not be, but we had passed other crew members that said nothing and some dressed like they were higher up. So, we stopped walking the Lower Promenade, but I don't know. When going back in, we ended up in the casino where someone commented -- ah, fresh air. The jogging trail at the top was crowded with putt-putt players and not covered and protected from the wind, like I enjoy about a promenade deck. 

{% image "legacy/IMG_5942.webp", "2048x1536" %}
...
{% image "legacy/IMG_5947.webp", "2048x1536" %}
{% image "legacy/IMG_5944.webp", "2048x1536" %}
{% image "legacy/IMG_5945.webp", "1536x2048" %}
{% image "legacy/IMG_5946.webp", "2048x1536" %}
...
{% image "legacy/IMG_5951.webp", "1536x2048" %}
{% image "legacy/IMG_5952.webp", "2048x1536" %}
{% image "legacy/IMG_5953.webp", "1536x2048" %}
{% image "legacy/IMG_5954.webp", "2048x1536" %}
