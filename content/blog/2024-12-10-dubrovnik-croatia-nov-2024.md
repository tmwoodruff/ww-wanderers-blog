...
{% image "legacy/IMG_0282.webp", "2048x1536" %}

There were blogs recommending the Walk the Walls entrances on the east side for less crowds, but the west side, near Pile Gate, was closer. The winter Walls ticket prices started on November 1st; $15 per person instead of $30 per person in the summer. So, I think that winter also reduced the crowds on the west side of the Walls. We were the only ones buying tickets at the time. The Walls took credit cards (something that I was trying to confirm for sure before we left) and charged in EURs. Another note is that they provide one restroom on the way; however, they don't tell you and there is no indication that there is only one restroom. We skipped it, fully expecting another before leaving; the old town and so the walls length were big (maybe they have additional during the summer). They will not let you back in (we tried an east entrance with our tickets) or go backwards/walking on the walls is one-way. I guess that would have been a plus of starting on the east; then thr restroom would be near the end. The original entrance guy that we talked try to send us to the paid restroom near the Hard Rock. This was the only disappointing part of Dubrovnik -- give us info about the _only_ restroom or put it on the ticket. Besides that, Dubrovnik was so beautiful and maybe my favorite -- with the Amalfi Coast. We did get to go to the restroom at the Fort. The Walls ticket covered the Walls, the Fort, and the Outer West Wall. More on those later. Walking the Walls entailed climbing stairs up to the top; the Walls were a fortress around the old town. Then walking all around the old town on the walls; there were still stairs up and down as the wall level changed. Recommendations that I heard were to walk them early before they were as crowded and as hot. Views from the Walls and looking down into the old town: 

{% image "legacy/IMG_0287.webp", "2048x1536" %}
{% image "legacy/IMG_0288.webp", "2048x1536" %}
{% image "legacy/IMG_0289.webp", "2048x1536" %}
{% image "legacy/IMG_0291.webp", "1536x2048" %}
{% image "legacy/IMG_0293.webp", "1536x2048" %}
{% image "legacy/IMG_0296.webp", "2048x1536" %}
{% image "legacy/IMG_0297.webp", "2048x1536" %}

The views of the Mediterranean and Croatia's shore were stunning. This is the Fort -- Fort Lovrijenac. 

{% image "legacy/IMG_0298.webp", "2048x1536" %}
{% image "legacy/IMG_0300.webp", "1536x2048" %}
{% image "legacy/IMG_0301.webp", "2048x1536" %}
{% image "legacy/IMG_0304.webp", "2048x1536" %}
{% image "legacy/IMG_0305.webp", "2048x1536" %}
{% image "legacy/IMG_0307.webp", "2048x1536" %}
{% image "legacy/IMG_0310.webp", "2048x1536" %}
{% image "legacy/IMG_0311.webp", "2048x1536" %}
{% image "legacy/IMG_0312.webp", "2048x1536" %}
{% image "legacy/IMG_0313.webp", "2048x1536" %}
{% image "legacy/IMG_0317.webp", "2048x1536" %}
{% image "legacy/IMG_0318.webp", "2048x1536" %}
{% image "legacy/IMG_0321.webp", "1536x2048" %}
{% image "legacy/IMG_0323.webp", "2048x1536" %}
{% image "legacy/IMG_0326.webp", "2048x1536" %}
{% image "legacy/IMG_0334.webp", "2048x1536" %}

The semi-submergible submarine tours. I looked into it but in the end decided against it. 

{% image "legacy/IMG_0335.webp", "2048x1536" %}
{% image "legacy/IMG_0339.webp", "2048x1536" %}
{% image "legacy/IMG_0340.webp", "2048x1536" %}
{% image "legacy/IMG_0342.webp", "2048x1536" %}
{% image "legacy/IMG_0343.webp", "1536x2048" %}

The wildlife of the old town -- pigeons and a black cat. 

{% image "legacy/IMG_0344.webp", "2048x1536" %}
{% image "legacy/IMG_0345.webp", "1536x2048" %}
{% image "legacy/IMG_0346.webp", "1536x2048" %}
{% image "legacy/IMG_0347.webp", "1536x2048" %}
{% image "legacy/IMG_0354.webp", "1536x2048" %}
{% image "legacy/IMG_0356.webp", "2048x1536" %}
{% image "legacy/IMG_0357.webp", "1536x2048" %}
{% image "legacy/IMG_0358.webp", "2048x1536" %}
{% image "legacy/IMG_0359.webp", "1536x2048" %}
{% image "legacy/IMG_0362.webp", "2048x1536" %}
{% image "legacy/IMG_0364.webp", "2048x1536" %}
{% image "legacy/IMG_0366.webp", "2048x1536" %}
{% image "legacy/IMG_0370.webp", "1536x2048" %}
{% image "legacy/IMG_0383.webp", "2048x1536" %}
{% image "legacy/IMG_0388.webp", "2048x1536" %}
{% image "legacy/IMG_0391.webp", "2048x1536" %}
{% image "legacy/IMG_0402.webp", "2048x1536" %}

A basketball court in the old town with a view of the ocean. 

{% image "legacy/IMG_0408.webp", "2048x1536" %}
{% image "legacy/IMG_0497.webp", "2048x1536" %}
{% image "legacy/IMG_0410.webp", "2048x1536" %}
{% image "legacy/IMG_0413.webp", "2048x1536" %}
{% image "legacy/IMG_0414.webp", "2048x1536" %}
{% image "legacy/IMG_0416.webp", "1536x2048" %}
{% image "legacy/IMG_0418.webp", "2048x1536" %}
{% image "legacy/IMG_0420.webp", "1536x2048" %}
{% image "legacy/IMG_0422.webp", "2048x1536" %}
...
{% image "legacy/IMG_0427.webp", "2048x1536" %}
{% image "legacy/IMG_0432.webp", "2048x1536" %}
{% image "legacy/IMG_0434.webp", "2048x1536" %}
{% image "legacy/IMG_0435.webp", "1536x2048" %}
{% image "legacy/IMG_0436.webp", "2048x1536" %}
{% image "legacy/IMG_0438.webp", "2048x1536" %}
{% image "legacy/IMG_0440.webp", "2048x1536" %}
{% image "legacy/IMG_0443.webp", "2048x1536" %}

Travis made this well echo. 

{% image "legacy/IMG_0444.webp", "1536x2048" %}
{% image "legacy/IMG_0451.webp", "2048x1536" %}
{% image "legacy/IMG_0455.webp", "2048x1536" %}
{% image "legacy/IMG_0458.webp", "2048x1536" %}
{% image "legacy/IMG_0462.webp", "2048x1536" %}
{% image "legacy/IMG_0463.webp", "2048x1536" %}
{% image "legacy/IMG_0464.webp", "2048x1536" %}

The fortress on the hill. 

{% image "legacy/IMG_0465.webp", "2048x1536" %}

After the fort (and restroom stop there), we walked along the water. There were fish, kayakers, and a cave in the wall. 

{% image "legacy/IMG_0470.webp", "2048x1536" %}
{% image "legacy/IMG_0476.webp", "1536x2048" %}
{% image "legacy/IMG_0480.webp", "2048x1536" %}
{% image "legacy/IMG_0483.webp", "2048x1536" %}
{% image "legacy/IMG_0484.webp", "2048x1536" %}
{% image "legacy/IMG_0486.webp", "2048x1536" %}
{% image "legacy/IMG_0487.webp", "2048x1536" %}
{% image "legacy/IMG_0488.webp", "1536x2048" %}

Our sandwich was very good. It is the second one the menu below. The homemade bread was also very good. 

{% image "legacy/IMG_0489.webp", "2048x1536" %}
{% image "legacy/IMG_0490.webp", "2048x1536" %}
{% image "legacy/IMG_0491.webp", "2048x1536" %}

The old town main street was so shiny. The stairs took us to the last attraction the Outer Western Walls.

{% image "legacy/IMG_0493.webp", "1536x2048" %}
{% image "legacy/IMG_0495.webp", "1536x2048" %}
...
{% image "legacy/IMG_0498.webp", "2048x1536" %}
...
{% image "legacy/IMG_0499.webp", "1536x2048" %}
{% image "legacy/IMG_0500.webp", "2048x1536" %}
{% image "legacy/IMG_0505.webp", "2048x1536" %}
{% image "legacy/IMG_0506.webp", "2048x1536" %}
{% image "legacy/IMG_0509.webp", "1536x2048" %}
{% image "legacy/IMG_0510.webp", "2048x1536" %}
...
{% image "legacy/IMG_0512.webp", "2048x1536" %}
{% image "legacy/IMG_0513.webp", "2048x1536" %}
{% image "legacy/IMG_0514.webp", "2048x1536" %}
{% image "legacy/IMG_0521.webp", "2048x1536" %}
{% image "legacy/IMG_0518.webp", "2048x1536" %}
{% image "legacy/IMG_0516.webp", "2048x1536" %}
