...
{% image "legacy/IMG_4694.webp", "2048x1536" %}

The Blue Mosque 

{% image "legacy/IMG_4695.webp", "2048x1536" %}

Ashore, we docked at [Galataport Istanbul](https://www.google.com/maps/place/Galataport+Istanbul/@41.0279705,28.982418,17z/data=!3m1!4b1!4m5!3m4!1s0x14cab9d81ea6df6f:0x915b49a4a47881e7!8m2!3d41.0279705!4d28.9846067); this is one of the fanciest ports that I have seen and big. We had to scan our cruise key card to get out of the port and scan to leave. Normally, we just scan on and off the ship, so that they know who has left and if they have come back. I guess Istanbul wanted to know who came in and that they left at the end of the day. They also gave us a survey on exit asking what we spent at the port and spent on the whole trip. 
...
{% image "legacy/IMG_4706.webp", "2048x1536" %}
...
{% image "legacy/IMG_4709.webp", "2048x1536" %}
{% image "legacy/IMG_4713.webp", "2048x1536" %}
{% image "legacy/IMG_4715.webp", "2048x1536" %}
{% image "legacy/P1100939.webp", "2048x1538" %}
{% image "legacy/P1100943.webp", "2048x1538" %}
...
{% image "legacy/IMG_4717.webp", "1536x2048" %}
{% image "legacy/IMG_4718.webp", "1536x2048" %}
{% image "legacy/IMG_4723.webp", "2048x1536" %}
{% image "legacy/IMG_4724.webp", "2048x1536" %}

The speaking pulpit. 

{% image "legacy/IMG_4725.webp", "1536x2048" %}
{% image "legacy/P1100956.webp", "1538x2048" %}
{% image "legacy/IMG_4727.webp", "2048x1536" %}
{% image "legacy/IMG_4728.webp", "2048x1536" %}
{% image "legacy/IMG_4729.webp", "1536x2048" %}
{% image "legacy/IMG_4731.webp", "2048x1536" %}

Center doom.

{% image "legacy/P1100962.webp", "2048x1538" %}
...
{% image "legacy/IMG_4733.webp", "2048x1536" %}
{% image "legacy/P1100965.webp", "2048x1538" %}
...
{% image "legacy/P1100973.webp", "2048x1538" %}

Ablutions Fountain

{% image "legacy/P1100980.webp", "2048x1538" %}

They had the upstairs closed. We read about it, and it sounded very interesting so was disappointing. 

{% image "legacy/IMG_4751.webp", "2048x1536" %}

The Blue Mosque was under construction, but they had completed the main doom. 

{% image "legacy/P1100991.webp", "2048x1538" %}
{% image "legacy/P1100996.webp", "2048x1538" %}
{% image "legacy/IMG_4749.webp", "1536x2048" %}
