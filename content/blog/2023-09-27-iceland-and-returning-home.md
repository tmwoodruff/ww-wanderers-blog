...
{% image "legacy/IMG_6895.webp", "2048x1536" %}
{% image "legacy/IMG_6899.webp", "2048x743" %}
{% image "legacy/IMG_6905.webp", "2048x1536" %}
{% image "legacy/IMG_6908.webp", "2048x1536" %}
{% image "legacy/IMG_6910.webp", "2048x1536" %}

Then found the recycled house. Very cool and interesting. I looked up the film that the owner directed; you can learn about it at[ https://eurodrama.wordpress.com/2016/05/16/dvd-review-the-raven-flies-hrafninn-flygur/]( https://eurodrama.wordpress.com/2016/05/16/dvd-review-the-raven-flies-hrafninn-flygur/) and watched the preview...it does not look very good. It is from 1984, so special effect were not what they are today. 

{% image "legacy/IMG_6912.webp", "2048x1536" %}
{% image "legacy/IMG_6915.webp", "2048x1536" %}
{% image "legacy/IMG_6916.webp", "2048x1536" %}

This partially underground building was also cool. 

{% image "legacy/IMG_6918.webp", "1536x2048" %}
...
{% image "legacy/IMG_6919.webp", "1536x2048" %}
{% image "legacy/IMG_6921.webp", "2048x1536" %}
{% image "legacy/IMG_6924.webp", "2048x1536" %}
{% image "legacy/IMG_6925.webp", "2048x1536" %}
...
{% image "legacy/IMG_6935.webp", "1536x2048" %}
{% image "legacy/IMG_6936.webp", "2048x1536" %}
{% image "legacy/IMG_6937.webp", "2048x1536" %}

This was at the hot springs, down in the moat/run off. This scooter had a rough night. 

{% image "legacy/IMG_6938.webp", "2048x1536" %}

Another similar in architecture church. 

{% image "legacy/IMG_6939.webp", "1536x2048" %}
{% image "legacy/IMG_6940.webp", "2048x1536" %}

We were not in New Zealand, but I think we found Hobbiton. 

{% image "legacy/IMG_6941.webp", "2048x1536" %}
{% image "legacy/IMG_6942.webp", "2048x1536" %}
{% image "legacy/IMG_6944.webp", "2048x1536" %}
{% image "legacy/IMG_6948.webp", "1536x2048" %}

I took the picture because the Stop sign said Stop in English. 

{% image "legacy/IMG_6950.webp", "1536x2048" %}

On the walk back to the port, I think that gas, in liters, was expensive, but I'm not sure. Interesting pumps. 

{% image "legacy/IMG_6953.webp", "2048x1536" %}
{% image "legacy/IMG_6955.webp", "2048x1536" %}
...
{% image "legacy/IMG_6966.webp", "2048x1536" %}
{% image "legacy/IMG_6969.webp", "2048x1536" %}
...
{% image "legacy/IMG_6971.webp", "1536x2048" %}
{% image "legacy/IMG_6972.webp", "1536x2048" %}
