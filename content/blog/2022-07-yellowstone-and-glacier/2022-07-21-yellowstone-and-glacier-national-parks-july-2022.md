...
{% image "legacy/IMG_5167.webp", "2048x1536" %}
{% image "legacy/P1110384.webp", "2048x1538" %}

A pool on the same trail, which had additional geysers and pools. 

{% image "legacy/P1110372.webp", "2048x1538" %}
...
{% image "legacy/IMG_5178.webp", "2048x1536" %}

Opal Pool was very pretty in the morning. 

{% image "legacy/P1110392.webp", "2048x1538" %}
...
{% image "legacy/IMG_5181.webp", "2048x1536" %}
...
{% image "legacy/IMG_5185.webp", "2048x1536" %}
...
{% image "legacy/IMG_5172.webp", "1536x2048" %}
{% image "legacy/IMG_5168.webp", "2048x1536" %}
{% image "legacy/P1110403.webp", "2048x1538" %}

One with the lake and pool

{% image "legacy/P1110405.webp", "2048x1538" %}
{% image "legacy/P1110406.webp", "2048x1538" %}
...
{% image "legacy/IMG_5241.webp", "2048x1536" %}
{% image "legacy/IMG_5239.webp", "2048x1536" %}

Bison at the Yellowstone river; we got a view from an overlook on the other side of the road.

{% image "legacy/IMG_5224.webp", "2048x1536" %}
{% image "legacy/P1110430.webp", "1364x2048" %}

LeHardys Rapid beside Hayden Valley. 

{% image "legacy/IMG_5220.webp", "2048x1536" %}
{% image "legacy/IMG_5217.webp", "1536x2048" %}

Mud Volcano

{% image "legacy/P1110420.webp", "2048x1538" %}
{% image "legacy/P1110408.webp", "2048x1538" %}
{% image "legacy/P1110422.webp", "2048x1538" %}

Dragon's breath

{% image "legacy/P1110427.webp", "1538x2048" %}
...
{% image "legacy/P1110440.webp", "1538x2048" %}
